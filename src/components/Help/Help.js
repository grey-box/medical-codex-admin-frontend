...
const Help=()=>{
    return(
        ...
        <img src={`${process.env.PUBLIC_URL}/pills.png`} className="pills" alt="green and blue pills" />
        </div>
      </div>
    ...
    <section id="help" class="help1">
      ...
      <img src={`${process.env.PUBLIC_URL}/whitepills.png`} className="white-pills" alt="white pills" />
