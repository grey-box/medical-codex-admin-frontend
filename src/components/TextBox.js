...
const TextBox = ({ selectedLanguage, languagesList,style, setInputText, value, outputvalue ,setShowLists}) => {
    ...
    return (
        ...
        <div className="textbox-child2" >
            ...
            <button className="selection-button" onClick={()=>setShowLists(style)}>List</button>
        </div>
        </div>
        <br/>
